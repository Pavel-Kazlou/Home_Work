...
public class MainArrayList {
    ...
    /**
     * Главный метод создает ArrayList-ы из 1000000 человек и животных:
...
//Работа с коллекцией людей
        List<Person> personList = new ArrayList<>();                      // Инициализация коллекции
        ...
        Collections.sort(personList, new SortByPassLengthAndNick());      // Сортировка

        Iterator<Person> personIterator = personList.iterator();          // Итератор
        long start2 = System.currentTimeMillis();
        while (personIterator.hasNext()) {
            Person element = personIterator.next();
        ...
        personList.remove(2);                                       // Удаление одного элемента по индексу
        personList.removeAll(personList);                                 // Удаление всех элементов коллекции
        long stop3 = System.currentTimeMillis();
        System.out.println();

//Работа с коллекцией животных
        List<Animal> animalList = new ArrayList<>();                      // Инициализация коллекции
        ...
        Collections.sort(animalList, new SortByAgeAndAnimalNick());       // Сортировка
