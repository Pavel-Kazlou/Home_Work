...
public class MainLinkedList {
    ...
    /**
     * Главный метод создает LinkedList-ы из 1000000 человек и животных:
...
//Работа с коллекцией людей
        LinkedList<Person> personList = new LinkedList<>();             // Инициализация коллекции
...
//Работа с коллекцией животных
        LinkedList<Animal> animalList = new LinkedList<>();              // Инициализация коллекции
